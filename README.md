...
### Method 2: From Coolitis Repository (Auto-Updates)

1. **Download the repo ZIP**  
   [repository.coolitis-1.0.0.zip](https://github.com/coolitis/repository.coolitis/archive/refs/heads/main.zip)
...
1. Open **Nollywood Movies** from Video Add-ons
2. Browse:
   - **Latest Releases**
   - **Most Popular**
...
| Option | Description |
|-------|-------------|
| **Force Update yt-dlp** | Refresh streaming engine |
...
This add-on **does not host** any content.  
It uses **publicly available links** via **yt-dlp**.  
